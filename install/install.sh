...
msg() {
	case "$LANG_CODE:$1" in
		...
		de:restart_once) printf 'Wenn eine Installation oder Aktualisierung noetig ist, startet der Lautsprecher zweimal neu.' ;;
		...
		de:final_restart_hint) printf '(das kann bis zu eine Minute dauern)' ;;
